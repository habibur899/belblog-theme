...
<div id="comments" class="comment-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<ul class="comment-list single-comment">
			<?php
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
			<nav class="navigation comment-navigation" role="navigation">
				...
				<h1 class="screen-reader-text section-heading"><?php _e( 'Comment navigation', 'belblog' ); ?></h1>
				<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'belblog' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'belblog' ) ); ?></div>
			</nav><!-- .comment-navigation -->
		<?php endif; // Check for comment navigation ?>

		<?php if ( ! comments_open() && get_comments_number() ) : ?>
			<p class="no-comments"><?php _e( 'Comments are closed.', 'belblog' ); ?></p>
		<?php endif; ?>
	...
	$comments_args = array(
		...
		'label_submit'         => __( 'Post Comment', 'belblog' ),
		'class_submit'         => 'btn-one',
		'id_form'              => '',
		'id_submit'            => '',
		'class_container'      => 'discussion-form-area comments',
		'class_form'           => 'contact-form',
		// change the title of the reply section
		'title_reply'          => __( 'Leave a Reply', 'belblog' ),
		'title_reply_to'       => __( 'Leave a Reply to %s', 'belblog' ),
		'title_reply_before'   => '<h4 class="dis-form-title">',
		'title_reply_after'    => '</h4>',
		'cancel_reply_before'  => ' <small>',
		'cancel_reply_after'   => '</small>',
		'cancel_reply_link'    => __( 'Cancel reply', 'belblog' ),
		...
		'comment_field'        => '<div class="row"><div class="form-group"><textarea id="comment" class="form-control" name="comment" placeholder="Your Reply *" aria-required="true" rows="6" data-error="Leave a message for me"></textarea><div class="help-block with-errors"></div></div>',
